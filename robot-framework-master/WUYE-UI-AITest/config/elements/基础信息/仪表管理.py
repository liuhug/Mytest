...
仪表类型 模块
'''
仪表类型新增="xpath=//div[@class='ListButton___2wYfD']/div/div/button[1]" # "xpath=//div[@class='ListButton___2cfy4']/div/div/button[1]"
仪表类型编辑= "xpath=//tbody/tr[1]/td[8]/div/span/a[1]" # "xpath=//div[@class='ListButton___2wYfD']/div/div/button[2]"
仪表类型删除= "xpath=//tbody/tr[1]/td[8]/div/span/a[2]" # "xpath=//div[@class='ListButton___2wYfD']/div/div/button[3]"
仪表类型名称="id=name"
仪表类型名称高="id=Name"
计量单位="id=unit"
仪表类型保存="xpath=//div[@class='ant-modal-footer']//button[2]"
仪表类型取消="xpath=//div[@class='ant-modal-footer']//button[1]"
仪表类型搜索框="xpath=//div[@class='ListButton___2wYfD']/div/div[2]/span/span/input"
仪表类型搜索按钮="xpath=//div[@class='ListButton___2wYfD']/div/div[2]/span/span/span/button"
仪表类型列表数据="xpath=//tbody/tr[1]/td[2]"
仪表类型高级搜索="xpath=//div[@class='ListButton___2wYfD']/div/div[2]/a"
仪表类型高级搜索按钮="xpath=//div[@class='ant-card-body']//button[2]"
仪表类型确认删除="xpath=//div[@class='ant-popover-buttons']/button[2]"
收起搜索="xpath=//div[@class='ListButton___2wYfD']/div/div[2]/a"

#断言
更新仪表成功="//span[text()='更新仪表成功！']"
创建仪表成功="//span[text()='创建仪表成功！']"
删除仪表类型="//div[@class='ant-message-custom-content ant-message-success']/span[2]"

'''
房间仪表管理和公摊仪表管理通用的按钮定位
'''
房间仪表新增= "id=btnNew"      # "xpath=//div[_nk='JG9da1']"
仪表新建="id=btnAdd"
仪表编辑="id=btnEdit"
仪表删除="id=btnDelete"
仪表换表="id=btnChange"
