...
class MyString():
    ...
    def save_Cookis(self,cookies):
        with open('D:/wuye/robot-framework-master/WUYE-UI-AITest/cookies.txt', 'w') as fp:
    ...
    '''
    def set_Cookie(self):
        with open("D:/wuye/robot-framework-master/WUYE-UI-AITest/cookies.txt", 'r') as fp:
...
if __name__=='__main__':
    ...
    # header = s.read_app_header("app_text_token_header" 'http://10.10.120.171:8081/Nova.Pms.OpenId/Access/Token',
    #                            'testing', '123456')